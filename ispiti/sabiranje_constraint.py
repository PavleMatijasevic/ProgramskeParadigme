...
problem.addVariable("TE",range(1, 10))
problem.addVariable("WOIGHLV", range(10))

def ogranicenje(t, e, w, o, i, g, h, l, v):
    if ((t*100 + w*10 + o)+(t*100 + w*10 + o))*(e*10000 + i*1000 + g*100 + h*10 + t) == (e + v*10 + l*100 + e*1000 + w*10000 + t*100000):
        return True

problem.addConstraint(ogranicenje, "TEWOIGHLV")
